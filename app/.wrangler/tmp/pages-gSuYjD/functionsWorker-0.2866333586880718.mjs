...
// api/blocks.ts
var SOURCE = "https://api.blockchair.com/zcash/blocks";
var FIELDS = "id,time,coinbase_data_hex,guessed_miner";
var FRESH_SECONDS = 30;
var KEEP_SECONDS = 3600;
var MAX_LIMIT = 100;
var KEY = "https://ring.internal/blocks";
function age(response) {
  const at = Number(response.headers.get("x-fetched-at") ?? "0");
  return at === 0 ? Number.POSITIVE_INFINITY : Math.floor((Date.now() - at) / 1e3);
}
__name(age, "age");
function serve(body, fetchedAt, stale) {
  return new Response(body, {
    headers: {
      ...
      "x-data-age-seconds": String(Math.max(0, Math.floor((Date.now() - fetchedAt) / 1e3))),
...
var onRequest = /* @__PURE__ */ __name(async (context) => {
  ...
  if (held !== void 0 && age(held) < FRESH_SECONDS) {
...
// ../.wrangler/tmp/pages-gSuYjD/functionsRoutes-0.5328098367095746.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-m59ItK/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-m59ItK/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2866333586880718.mjs.map
